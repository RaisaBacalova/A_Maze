...
public class Door : MonoBehaviour {
    ...
    Quaternion rightDoorStartRotatation;
    ...
    void Start () {
        ...
        Quaternion leftDoorStartRotation = Quaternion.Euler(-90.00001f, 0f, 90.037f);
        Quaternion leftDoorEndRotation = leftDoorStartRotation * Quaternion.Euler(-180.00001f, 180f, -90.037f);
        Quaternion rightDoorStartRotation = Quaternion.Euler(-90.00001f, 0f, -90.03101f);
        Quaternion rightDoorEndRotation = rightDoorStartRotation * Quaternion.Euler(-180.00001f, -180f, 90.03101f);
